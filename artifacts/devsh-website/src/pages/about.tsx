...
const vulkanisedPhotos: { src: string; alt: string }[] = [
    { src: "/vulkanised_photos/2026/2026_01.jpg", alt: "Vulkanised 2026 photo 1" },
    { src: "/vulkanised_photos/2026/2026_02.jpg", alt: "Vulkanised 2026 photo 2" },
    { src: "/vulkanised_photos/2026/2026_04.jpg", alt: "Vulkanised 2026 photo 4" },
    { src: "/vulkanised_photos/2026/2026_03.jpg", alt: "Vulkanised 2026 photo 3" },
    { src: "/vulkanised_photos/2026/2026_06.jpg", alt: "Vulkanised 2026 photo 6" },
    { src: "/vulkanised_photos/2026/2026_08.jpg", alt: "Vulkanised 2026 photo 8" },
    { src: "/vulkanised_photos/2026/2026_09.jpg", alt: "Vulkanised 2026 photo 9" },
    { src: "/vulkanised_photos/2026/2026_07.jpg", alt: "Vulkanised 2026 photo 7" },
    { src: "/vulkanised_photos/2023/2023_1.jpg", alt: "Vulkanised 2023 photo 1" },
    { src: "/vulkanised_photos/2023/2023_2.jpg", alt: "Vulkanised 2023 photo 2" },
    { src: "/vulkanised_photos/2024/2024_1.jpg", alt: "Vulkanised 2024 photo 1" },
    { src: "/vulkanised_photos/2024/2024_2.jpg", alt: "Vulkanised 2024 photo 2" },
];

function VulkanisedPhoto({ src, alt }: { src: string, alt: string }) {
    return (
        <div className="relative w-[400px] aspect-video overflow-hidden rounded-md bg-neutral-900/70 ring-1 ring-white/5">
            <img
                ...
                alt=""
                aria-hidden="true"
                className="absolute inset-0 w-full h-full object-cover blur-lg scale-105 opacity-60"
            />
            <img
                src={src}
                alt={alt}
        ...
        <main className="container mx-auto max-sm:px-8 flex flex-col gap-4 sm:gap-8 sm:items-center h-full justify-center">
            <Chapter title="About Us">
                <Paragraph>
                    ...
                    <br />
                    <br />
                    The primary mission for all of our self-funded developments is to advance Open Source ecosystems with innovative tooling with a particular focus on Khronos Standards. We maintain a single source HLSL202x/C++20 Standard Template Header Only Library and our Utility and Rapid Prototyping Framework <a href="https://github.com/Devsh-Graphics-Programming/Nabla" target="_blank" rel="noopener noreferrer" className="no-underline text-teal-600 devsh-link">Nabla</a>{" "}
