...
function PastProject({company, companyWebsite, images, videos, projects}: PastProjectProps) {
    return (
        <div>
            <h3>
                For {companyWebsite ? 
                    <a href={companyWebsite} target="_blank" rel="noopener noreferrer" className="devsh-link">{company}</a>
                    : <>{company}</>
                }
            </h3>
                ...
                <Chapter title="Past Projects">
                    <div className="flex flex-col gap-8">
                        <PastProject 
                            ...
                            images={["/nabla_screenshot1.jpg", "/clients/ditt/ditt1.jpg", "/clients/ditt/ditt2.jpg", "/clients/ditt/ditt3.jpg", "/clients/ditt/ditt4.png", "/clients/ditt/ditt5.jpg"]}
                            projects={[
                        ...
                        <PastProject
                            ...
                            images={["/clients/baw/volume_reconstruct.png", "/clients/baw/baw1.jpg", "/clients/baw/baw2.jpg", "/clients/baw/baw3.jpg", "/clients/baw/baw4.jpg", "/clients/baw/baw5.jpg", "/clients/baw/baw6.jpg", "/clients/baw/baw7.jpg"]}
                            projects={[
                        ...
                        <PastProject
                            ...
                            images={["/clients/apps_in_cadd/n4ce_1.jpg"]}
                        ...
                        <PastProject
                            ...
                            images={["/clients/wild/wild_gif1.gif", "/clients/wild/wild_gif2.gif", "/clients/wild/wild1.jpg", "/clients/wild/wild2.jpg", "/clients/wild/wild3_v2.jpg", "/clients/wild/wild4.jpg"]}
                            projects={[
                        ...
                        <PastProject
                            ...
                            projects={[
                                <>Investigation of the new .Net 6 WASM and Blazor SDKs <a className="devsh-link" href="http://github.com/Devsh-Graphics-Programming/JS-WASM-interop-benchmark">(example issues reported to Microsoft)</a></>,
